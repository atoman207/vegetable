...
values
  ('01', '高橋 美佳',   'Mika Takahashi',    '北海道', '北海道', 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?auto=format&fit=crop&w=1200&q=80', 'じゃがいも・玉ねぎ・アスパラガス', '十勝の広大な大地と雪解け水が、素材本来の甘みを育てます。', array['じゃがいも','玉ねぎ','アスパラガス'], '十勝の大地で、素材の旨みを引き出す根菜作り。雪解け水が甘みをひきたてます。', 10, 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?auto=format&fit=crop&w=900&q=80', '収穫期のじゃがいも畑。', 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=900&q=80', '澄んだ空気と広大な農地。', 'https://images.unsplash.com/photo-1560493676-04071c5f467b?auto=format&fit=crop&w=900&q=80', '朝採りのアスパラガス。'),
  ('02', '木村 誠',     'Makoto Kimura',     '東北', '青森県', 'https://images.unsplash.com/photo-1560493676-04071c5f467b?auto=format&fit=crop&w=1200&q=80', 'りんご・長芋・にんにく', '津軽の寒暖差が育む、濃厚な旨みと歯ごたえ。', array['りんご','長芋','にんにく'], '岩木山を望む農園で、津軽の名産を自然栽培で育てています。', 20, 'https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?auto=format&fit=crop&w=900&q=80', 'たわわに実るふじりんご。', 'https://images.unsplash.com/photo-1512578659172-0ba4f2ebc997?auto=format&fit=crop&w=900&q=80', '収穫したての長芋。', 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&w=900&q=80', '雪化粧した岩木山を望む畑。'),
  ('03', '佐々木 翔',   'Sho Sasaki',        '東北', '秋田県', 'https://images.unsplash.com/photo-1472148439583-1f4cf81b80e0?auto=format&fit=crop&w=1200&q=80', 'あきたこまち・枝豆・じゅんさい', '田んぼの水が澄み、米も野菜も雑味なく甘く育ちます。', array['枝豆','じゅんさい','あきたこまち'], '清流と雪解け水に育まれた秋田の農産物を、丁寧に出荷しています。', 30, 'https://images.unsplash.com/photo-1560493676-04071c5f467b?auto=format&fit=crop&w=900&q=80', '棚田の稲刈り風景。', 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=900&q=80', '早朝の枝豆収穫。', 'https://images.unsplash.com/photo-1534531173927-aeb928d54385?auto=format&fit=crop&w=900&q=80', '沼で育つ希少なじゅんさい。'),
  ('04', '田中 健一',   'Kenichi Tanaka',    '関東', '茨城県', 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=1200&q=80', '小松菜・ほうれん草・水菜', '無化学肥料30年。土づくりから徹底した葉物野菜の名手。', array['小松菜','ほうれん草','水菜'], '土づくりからこだわった、葉物野菜の名手。無化学肥料で30年。', 40, 'https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?auto=format&fit=crop&w=900&q=80', 'みずみずしい小松菜。', 'https://images.unsplash.com/photo-1576181256399-834e3b3a49bf?auto=format&fit=crop&w=900&q=80', '堆肥を仕込む土づくり。', 'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?auto=format&fit=crop&w=900&q=80', '早朝の収穫風景。'),
  ('05', '鈴木 一郎',   'Ichiro Suzuki',     '関東', '千葉県', 'https://images.unsplash.com/photo-1511735111819-9a3f7709049c?auto=format&fit=crop&w=1200&q=80', '人参・じゃがいも・大根', '海風と砂地がつくる、独特の食感と自然な甘み。', array['人参','じゃがいも','大根'], '甘みのある根菜を、丁寧に育てています。海風と砂地がつくる、独特の食感。', 50, 'https://images.unsplash.com/photo-1447175008436-054170c2e979?auto=format&fit=crop&w=900&q=80', '鮮やかなオレンジの人参。', 'https://images.unsplash.com/photo-1589927986089-35812388d1f4?auto=format&fit=crop&w=900&q=80', '砂地でのびのび育つ大根。', 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?auto=format&fit=crop&w=900&q=80', '海沿いの畑と朝日。'),
  ('06', '渡辺 浩司',   'Koji Watanabe',     '中部', '長野県', 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=1200&q=80', 'レタス・セロリ・ブロッコリー', '標高1,000mの高原で育つ、シャキッと歯ごたえのある高原野菜。', array['レタス','セロリ','ブロッコリー'], '標高1,000mの高原で育つ、シャキシャキ野菜。朝霧が旨みを閉じ込めます。', 60, 'https://images.unsplash.com/photo-1622205313162-be1d5712a43f?auto=format&fit=crop&w=900&q=80', '朝霧に包まれる高原畑。', 'https://images.unsplash.com/photo-1560155016-bd4879ae8f21?auto=format&fit=crop&w=900&q=80', '収穫直後のレタス。', 'https://images.unsplash.com/photo-1515543904379-3d757afe72e4?auto=format&fit=crop&w=900&q=80', '丘陵地帯のキャベツ畑。'),
  ('07', '小林 友里',   'Yuri Kobayashi',    '中部', '静岡県', 'https://images.unsplash.com/photo-1524594081293-190a2fe0baae?auto=format&fit=crop&w=1200&q=80', 'みつば・わさび菜・クレソン', '富士山の湧水で育つ、香り豊かな葉物野菜。', array['みつば','わさび菜','クレソン'], '富士山の湧水で育む、香り豊かな葉物。料亭からの指名も多い、若手の注目農家。', 70, 'https://images.unsplash.com/photo-1576181256399-834e3b3a49bf?auto=format&fit=crop&w=900&q=80', '清流に育つわさび菜。', 'https://images.unsplash.com/photo-1534531173927-aeb928d54385?auto=format&fit=crop&w=900&q=80', '富士山を望む畑。', 'https://images.unsplash.com/photo-1588702547923-7093a6c3ba33?auto=format&fit=crop&w=900&q=80', '摘みたてのクレソン。'),
  ('08', '山本 真由美', 'Mayumi Yamamoto',   '関西', '京都府', 'https://images.unsplash.com/photo-1532012197267-da84d127e765?auto=format&fit=crop&w=1200&q=80', '京野菜・九条ねぎ・聖護院かぶ', '祖父の代から受け継ぐ畑で、京の伝統野菜を現代へ。', array['京野菜','九条ねぎ','聖護院かぶ'], '京の伝統野菜を、現代の食卓へ。祖父の代から受け継ぐ畑で育てています。', 80, 'https://images.unsplash.com/photo-1615485291234-9d694218aeb0?auto=format&fit=crop&w=900&q=80', '九条ねぎの畝。', 'https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=900&q=80', '聖護院かぶの収穫。', 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=900&q=80', '京都の里山風景。'),
  ('09', '伊藤 大輔',   'Daisuke Ito',       '関西', '兵庫県', 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=1200&q=80', '淡路玉ねぎ', '三年がかりの土づくりで生まれる、生で食べられる極甘玉ねぎ。', array['玉ねぎ'], '三年がかりの土づくりが育む、極甘の淡路玉ねぎ。生でかじれる、と評判です。', 90, 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&w=900&q=80', '一面の玉ねぎ畑。', 'https://images.unsplash.com/photo-1553531384-cc64ac80f931?auto=format&fit=crop&w=900&q=80', '吊るして熟成中の玉ねぎ。', 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?auto=format&fit=crop&w=900&q=80', '淡路島の海と畑。'),
  ('10', '岡田 優子',   'Yuko Okada',        '中国・四国', '広島県', 'https://images.unsplash.com/photo-1597474561103-0b99b2c9dfd6?auto=format&fit=crop&w=1200&q=80', 'レモン・ブロッコリー・キャベツ', '瀬戸内海の陽光と潮風が、爽やかな柑橘と甘い葉物を育てます。', array['レモン','ブロッコリー','キャベツ'], '瀬戸内の温暖な気候を活かした、環境に優しい農業を実践しています。', 100, 'https://images.unsplash.com/photo-1590502593747-42a996133562?auto=format&fit=crop&w=900&q=80', '瀬戸内レモンの収穫。', 'https://images.unsplash.com/photo-1587334274328-64186a80aeee?auto=format&fit=crop&w=900&q=80', '島の段々畑。', 'https://images.unsplash.com/photo-1515872474884-c6e9e06ec93e?auto=format&fit=crop&w=900&q=80', '丁寧な選別作業。'),
  ('11', '松本 拓也',   'Takuya Matsumoto',  '中国・四国', '高知県', 'https://images.unsplash.com/photo-1588702547923-7093a6c3ba33?auto=format&fit=crop&w=1200&q=80', 'なす・ピーマン・ししとう', '太陽の恵みをたっぷり浴びた、ハリのある夏野菜。', array['なす','ピーマン','ししとう'], '年間を通して温暖な高知で、太陽の恵みをそのままに出荷します。', 110, 'https://images.unsplash.com/photo-1590779033100-9f60a05a013d?auto=format&fit=crop&w=900&q=80', '艶やかな米なす。', 'https://images.unsplash.com/photo-1533279443086-d1c5e7caf95e?auto=format&fit=crop&w=900&q=80', 'ハウス内の緑の絨毯。', 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=900&q=80', '朝採れのししとう。'),
  ('12', '佐藤 みどり', 'Midori Sato',       '九州・沖縄', '熊本県', 'https://images.unsplash.com/photo-1524594081293-190a2fe0baae?auto=format&fit=crop&w=1200&q=80', 'ミニトマト・中玉トマト', '糖度は常に8度以上。阿蘇の伏流水が甘みを引き出します。', array['ミニトマト','中玉トマト'], '甘みと酸味のバランスにこだわる、トマト専業農家。糖度は常に8度以上。', 120, 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?auto=format&fit=crop&w=900&q=80', '熟したミニトマト。', 'https://images.unsplash.com/photo-1592841200221-a6898f307baa?auto=format&fit=crop&w=900&q=80', 'ハウスでの栽培風景。', 'https://images.unsplash.com/photo-1546470427-e8d2f0e1b98d?auto=format&fit=crop&w=900&q=80', 'パッキング中の朝採りトマト。'),
  ('13', '中村 剛',     'Tsuyoshi Nakamura', '九州・沖縄', '鹿児島県', 'https://images.unsplash.com/photo-1501771078058-5c73a7b7ffdf?auto=format&fit=crop&w=1200&q=80', 'さつまいも・大根', '黒土と潮風が育てる、ほくほく食感と辛味のバランス。', array['さつまいも','大根'], '黒土と潮風が生む、ほくほくのさつまいもと、辛味ある桜島大根。', 130, 'https://images.unsplash.com/photo-1597474561103-0b99b2c9dfd6?auto=format&fit=crop&w=900&q=80', '掘りたてのさつまいも。', 'https://images.unsplash.com/photo-1589927986089-35812388d1f4?auto=format&fit=crop&w=900&q=80', '桜島大根の重量感。', 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&w=900&q=80', '桜島を望む畑。'),
  ('14', '吉田 亜希',   'Aki Yoshida',       '九州・沖縄', '沖縄県', 'https://images.unsplash.com/photo-1590502593747-42a996133562?auto=format&fit=crop&w=1200&q=80', 'ゴーヤ・ハンダマ・島らっきょう', '琉球野菜を次世代へ。年中出荷できる、沖縄ならではの強み。', array['ゴーヤ','ハンダマ','島らっきょう'], '琉球野菜を受け継ぎ、未来へつなぐ。年中出荷できるのが沖縄の強み。', 140, 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=900&q=80', 'つややかなゴーヤ。', 'https://images.unsplash.com/photo-1587334274328-64186a80aeee?auto=format&fit=crop&w=900&q=80', 'ハンダマの鮮やかな葉。', 'https://images.unsplash.com/photo-1543362906-acfc16c67564?auto=format&fit=crop&w=900&q=80', '収穫間近の島らっきょう。')
on conflict do nothing;
